...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      projectDetails: "Built using React and CSS with Java Spring Boot backend and MySQL database. Features include comprehensive client purchase tracking, automated payment reminders, profit margin calculations, and detailed business analytics with Chart.js visualizations.",
